...
| [`scripts/track-menu.lua`](scripts/track-menu.lua) | Three-column selector overlay — audio tracks, subtitles, and live sound toggles (night mode, dialogue boost) remembered per folder, with an auto true-peak limiter |
